...
This directory contains a tiny standalone C++20 library and demo executable that exercise the kinds of declarations Oroboros can parse and emit bindings for. We call the library and executable Cosmos, to make it stand out when working through this example; also, it is meant to include the "cosmos" (universe) of all bindable C++ constructions.
...
- `bindings`: code to generate binding code for cosmos using oroboros
